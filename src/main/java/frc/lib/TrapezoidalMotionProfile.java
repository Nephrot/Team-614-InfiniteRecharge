...
//     /**
//      * Initialize the TMP, to give you a rundown target is the entire position, maxVelocity is the peak speed, maxAcceleration is the 
//      *
...
//  * @see         Image
//  */
// 	public TrapezoidalMotionProfile(double target, double maxVelocity, double maxAcceleration, double vi, double vf, boolean reverse) {
//         this.reverse = target < 0 ? reverse : false;

//         target = Math.abs(target);
//         this.target = target;

//         if(maxVelocity < 0){
//             System.err.println("Error | Peak velocity cant be negative and has been fixed, if you want to use the reverse function properly make reverse true and the target is negative!");
//         }
//         maxVelocity = Math.abs(maxVelocity);
//         this.maxVelocity = maxVelocity;

//         if(maxAcceleration < 0){
//             System.err.println("Error | Peak acceleration cant be negative and has been fixed, if you want to use the reverse function properly make reverse true and the target is negative!");
//         }
//         maxAcceleration = Math.abs(maxAcceleration);
//         this.maxAcceleration = maxAcceleration;

//         if(vi < 0){
//             System.err.println("Error | Velocity initial can't be negative and has been fixed, if you want to use the reverse function properly make reverse true and the target is negative!");
//         }
//         vi = Math.abs(vi);
//         this.vi = vi;
